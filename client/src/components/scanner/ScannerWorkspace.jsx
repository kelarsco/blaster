            ...
            {EXTRACT_OPTIONS.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium border transition text-left ${
                    active
...
export const DEFAULT_EXTRACT_OPTIONS = { email: true, whatsapp: false, instagram: false, tiktok: false };
