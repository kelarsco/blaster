  ...
  return (
    <div className="p-4 sm:p-6 md:p-8">
      <div className="mb-4 md:mb-6">
        <h1 className="page-title-mobile">Domain Inbox</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <section className="bg-blaster-bg-card rounded-xl border border-blaster-border">
          <div className="px-4 py-3 border-b border-blaster-border font-semibold text-sm text-blaster-fg">Threads</div>
          <div className="max-h-[65vh] overflow-auto">
            {threads.length === 0 ? (
              <p className="text-sm text-blaster-muted p-4">No replies yet. Configure inbound webhook on a verified domain.</p>
            ) : (
              threads.map((t) => (
                <button
                  type="button"
